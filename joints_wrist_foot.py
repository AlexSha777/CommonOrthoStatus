...
from wrist_zone_working import ScrollOnPicture, WristDefects
...
class WristFootWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.finger_weight = {"1": 0.25, "2": 0.075, "3": 0.075, "4": 0.05, "5": 0.05}
    ...
    def update_text_label(self):
        ...
        self.ampute_level_coding = self.work_window.amputation_level_point.copy()
    ...
    def movement_def(self):
        if self.sender().getColor() == "#808080":
            ...
            if self.entering_artilatio ==[]:
                ...
                button_box.addWidget(self.button_new_1)
    ...
    def range_calculate(self):
        ...
        if self.entering_artilatio[1].text() and self.entering_artilatio[2].text() and self.entering_artilatio[3].text():
            ...
            if move_range<0 or 0 not in [first, second, third]:
                msgBox = QMessageBox()
                msgBox.setWindowTitle("Warning")
    ...
    def text_contr_formation(self):
        ...
        if self.artic_contacture !=[]:
            for artic in self.artic_contacture:
                artic_to_save = artic[:]
                artic_to_save.insert(0, self.filename[:8])
